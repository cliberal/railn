...
function getProjectPath() {
  if (
    __dirname.match(/node_modules[\/\\]railn[\/\\]local-cli[\/\\]util$/)
  ) {
...
const getBlacklistRE = () => {
  return createBlacklist([/.*\/__fixtures__\/.*/, /.*\/cora-rn\/node_modules\/react-native.*/, /.*\/railn\/node_modules\/react-native.*/]);
};
